/*
  # Complete Giveaway Platform Database Schema - Fresh Migration

  1. New Tables
    - `profiles` - User profiles with role-based access
    - `giveaways` - Main giveaway configurations
    - `prizes` - Prize information for each giveaway
    - `participants` - Giveaway participants with referral tracking
    - `entries` - Individual entry records with verification status
    - `winners` - Winner records with status tracking
    - `audit_logs` - System audit trail for important actions
  ...
  3. Features
    ...
    - Entry method tracking and verification
    - Winner management workflow
    - Comprehensive audit logging
    - File storage for banners and prize images
*/
...
-- Add table comments to help PostgREST understand relationships
...
-- Ensure foreign key constraint is properly named for PostgREST
